...
public class CustomerController extends AbstractController {
  ...
  @Operation(
      ...
      description = "Retrieves profile details for the authenticated customer")
  @ApiResponse(
      responseCode = "200",
  ...
  @Operation(
      summary = "Update current customer profile details",
  ...
  public ResponseEntity<CustomerProfileDto> updateProfile(
    ...
    customerPopulator.update(user, profile, updateCustomerDto);

    CustomerProfile updatedProfile = customerProfileService.update(user, profile);
    CustomerProfileDto profileDto =
        customerPopulator.toCustomerProfileDto(updatedProfile.getUser(), updatedProfile);
    return ResponseEntity.ok(profileDto);
  }
}
