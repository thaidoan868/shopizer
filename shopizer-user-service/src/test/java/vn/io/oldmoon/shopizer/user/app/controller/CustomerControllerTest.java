...
class CustomerControllerTest {
  ...
  class GetProfileTests {
    ...
    @Test
    @DisplayName("with CUSTOMER role should return 200 and CustomerProfileDto")
    ...
    @Test
    @DisplayName("with non-CUSTOMER role (e.g. ADMIN only) should return 403 Forbidden")
    ...
    @Test
    @DisplayName("when profile not found should return 404 Not Found")
  ...
  class UpdateProfileTests {
    ...
    @Test
    @DisplayName("with valid payload and CUSTOMER role should return 200 and updated profile")
    void updateProfile_WithValidPayload_ShouldReturn200AndUpdatedProfile() throws Exception {
      // Given
      UUID userId = UUID.randomUUID();
      User user =
          User.builder()
    ...
    void updateProfile_WithoutAuth_ShouldReturn401() throws Exception {
      UpdateCustomerDto updateDto = UpdateCustomerDto.builder().firstName("Alice").build();
    ...
    @Test
    @DisplayName("with non-CUSTOMER role (e.g. ADMIN only) should return 403 Forbidden")
    void updateProfile_WithAdminRoleOnly_ShouldReturn403() throws Exception {
      UUID userId = UUID.randomUUID();
      UpdateCustomerDto updateDto = UpdateCustomerDto.builder().firstName("Alice").build();
    ...
    @Test
    @DisplayName("with invalid phone number format should return 422 Unprocessable Entity")
